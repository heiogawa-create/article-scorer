  ...
  return (
    <section className="rounded-3xl border border-slate-700 bg-[#1e293b]/95 p-5 shadow-2xl shadow-slate-950/30 md:p-7">
      ...
      <div className="mt-5 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <p className="text-sm text-slate-400">6項目×20点で、合計100点満点としてAIが採点します。</p>
        <button
          className="rounded-2xl bg-cyan-500 px-6 py-3 font-bold text-slate-950 shadow-lg shadow-cyan-950/30 transition hover:bg-cyan-300"
          type="button"
          onClick={onScore}
          disabled={!canScore}
        >
